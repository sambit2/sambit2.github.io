...
My name is <a href="https://www.linkedin.com/in/sambitpraharaj/">Sambit Praharaj</a>. Currently, I am a final year PhD. I had started my new research adventure as a <b>PhD candidate</b> in the <b>Technology Enhanced Learning Innovations (TELI) </b> group in <a href="https://www.ou.nl/">Open University</a> of the Netherlands from 1st of September. My promotors are <a href="https://scholar.google.com/citations?user=fC3dymIAAAAJ">Prof. dr. Marcus Specht </a> and <a href="https://scholar.google.com/citations?user=v1hwiRAAAAAJ">Prof. dr. Hendrik Drachsler</a>. Additionally, I have <a href="https://scholar.google.de/citations?user=iI8G4nYAAAAJ&hl=de">Dr. Maren Scheffel</a> as my daily supervisor. My research primarily focuses on the use of Multimodal Learning Analytics (MMLA) in a Co-located Collaboration (CC) or remote collaboration scenario. Apart from diving deep into my PhD research, my other plans are to widen my knowledge and experience in Neural networks and Deep Learning by following other courses from Coursera and Udacity. I am also following other books and online resources to get hands-on experience in Scikit and Tensorflow. It can help me to strengthen my PhD research at later stages when I build the prediction models to support collaboration in real-time. My research interests revolve around Multimodal Learning, Technology Enhanced Learning, AI, Human Computer Interaction, Learning Analytics, Educational sciences and Psychological Behaviour. I live in the beautiful city of <a href ="http://www.valkenburg.nl/">Valkenburg</a> in the Netherlands sandwiched between Germany and Belgium in near proximity. 
